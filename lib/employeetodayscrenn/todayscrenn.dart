...
class TodayScreenEmployee extends StatefulWidget {
  // ignore: use_super_parameters
  const TodayScreenEmployee({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _TodayScreenEmployeeState createState() => _TodayScreenEmployeeState();
}

class _TodayScreenEmployeeState extends State<TodayScreenEmployee> {
