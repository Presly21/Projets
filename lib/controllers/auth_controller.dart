...
class AuthController extends GetxController {
  ...
  RxString accessToken = ''.obs; // Removed !
  RxString userRefreshToken = ''.obs; // Removed !

  RxBool savId = true.obs; // Removed !

  RxBool isLoggedIn = false.obs; // Removed !

  Rx<UserModel> userData = UserModel(userId: 1).obs; // Removed !

  Rx<String> userId = ''.obs; // Removed !
