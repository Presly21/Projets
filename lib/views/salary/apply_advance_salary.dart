...
class _ApplyAdvanceSalaryState extends State<ApplyAdvanceSalary> {
  final AdvanceSalaryController _advanceSalaryController = Get.find<AdvanceSalaryController>();
  ...
  void initState() {
    super.initState();
    leaveTypes = _announcementController.currencyList
        .where((currencyModel) => currencyModel.code != null)
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              if (selectedDate != null) {
                                ...
                                await _advanceSalaryController.applyForAdvanceSalary(
                                  date: date,
                                  currency: currency,
                                  amount: amount,
                                  reason: reason,
