    ...
    return GradientBackground(
      child: Scaffold(
        ...
        body: Container(
          ...
          child:  Column(
            children: [
              if (_userData.contactData?.mobileNumber != null)
                SettingListTile(
                  text: 'Mobile Number',
                  trailing: _userData.contactData!.mobileNumber,
                ),
              if (_userData.contactData?.address != null)
                SettingListTile(
                  text: 'Address',
                  trailing: _userData.contactData!.address,
                ),
              const SizedBox(height: 20),
              if (_userData.contactData?.email != null)
                SettingListTile(
                  text: 'Email',
                  trailing: _userData.contactData!.email,
                ),
            ],
          ),
        ),
