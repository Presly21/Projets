            ...
            children: [
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _cardWidget(
                          heading: 'Total',
                          number: _leaveController.totalExpectDay.value.toString(),
                        ),
                        _cardWidget(
                          heading: 'Taken',
                          number: _leaveController.totalRestDays.value.toString(),
                        ),
                        _cardWidget(
                          heading: 'Balance',
                          number: _leaveController.totalBalance.value.toString(),
                        ),
                      ],
                    ),
              ...
              Expanded(
                child: NotificationListener<ScrollNotification>(
                  ...
                  child: Obx(
                    () {
                      if (_leaveController.isLoading.value && _leaveController.filteredLeaves.isEmpty) {
                        return const ShimmerAnnouncementCard();
                      } else if (!_leaveController.isLoading.value && _leaveController.filteredLeaves.isEmpty) {
                        ...
                        child: DraggableScrollbar(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              LeaveListModel model = _leaveController.filteredLeaves[index];
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  heading,
                  style: CustomTextStyles.bodyTextStyle(color: AppColors.secondary),
                ),
                Text(
                  number,
                  style: const TextStyle(
              ...
              child: Column(
                children: [
                  Align(
                    ...
                    child: Icon(
                      Icons.cancel,
                      color: status.contains('rejected') ? Colors.red : Colors.transparent,
                    ),
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
