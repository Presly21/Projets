...
import 'package:nexmax_hrms/employeeattendance/homescreen.dart';
                    ...
                    children: [
                      ...
                      if (_userData.fullName != null)
                        listTile(
                          text: 'Attendance',
                          onTap: () {
                            Go.to(() => const HomeScreenEmpl());
                          },
                        ),
                      if (_userData.fullName != null)
                        listTile(
                          text: 'Leave and Allowance Entitlement',
                          onTap: () {
                      ...
                      //       Go.to(() => const CorporateInformation());
                      //     },
                      //     title: const Center(child: Text('Corporate information')),
                      //   ),
                      // ),
                       const SizedBox(height: 20),
                       Container(
                        ...
                        child: const ListTile(
                          ...
                          //   Go.to(() => const LeaveEntitlement());
                          // },
                          title: Center(child: Text('Leave and Allowance information')),
                        ),
                      ),
                       const SizedBox(height: 20),
                       Container(
