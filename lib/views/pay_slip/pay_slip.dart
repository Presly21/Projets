...
import 'package:nexmax_hrms/constants/no_data_widget.dart';
...
class _PaySlipPageState extends State<PaySlipPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(
        () {
          PaySlipModelList? filteredPaySlip = _paySlipController.getFilteredPaySlip();
              ...
              children: [
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              const Text(
                                'Select Year',
                                style: TextStyle(color: AppColors.primaryDull),
                              ),
                ...
                Expanded(
                  child: Builder(builder: (context) {
                    if (_paySlipController.isLoading.value && _paySlipController.paySlipList.isEmpty) {
                      return const ShimmerAnnouncementCard();
                    } else if (!_paySlipController.isLoading.value && _paySlipController.paySlipList.isEmpty) {
                    ...
                    return Padding(
                      ...
                      child: DraggableScrollbar(
                        ...
                        scrollThumbBuilder: (
                          ...
                          const alwaysVisibleThumbAnimation = AlwaysStoppedAnimation(1.0);
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            var model = _paySlipController.filteredPaySlips[index];
                            return GestureDetector(
                              onTap: () {
                                Get.to(() => PaySlipDetailPage(model: model));
                              },
                              child: Padding(
                                padding: const EdgeInsets.symmetric(vertical: 5, horizontal: 12),
                                child: PaySlipTimeLine(
                                  amount: model.basicSalary ?? '',
                                  startDate: DateFormat('dd-MMM-yyyy').format(model.firstDate!),
                                  endDate: DateFormat('dd-MMM-yyyy').format(model.lastDate!),
                                ),
                              ),
                            );
                          },
